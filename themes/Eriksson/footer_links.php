...
<div class="section">
	...
	echo "<li><a href='".BASEDIR."news.php?readmore=".$data['news_id']."'  title='".$data['news_subject']."' target='_blank'>".$newstitle."</a><span class='sep'></span></li>\n";
		}
	} else {
...
<div class="section">
	...
	if (dbrows($result)) {
		while($data = dbarray($result)) {
			...
			echo "<li><a href='".FORUM."viewthread.php?thread_id=".$data['thread_id']."' title='".$data['thread_subject']."'>".$itemsubject."</a><span class='sep'></span></li>\n";
		}
	} else {
...
<div class="section">
	...
	echo "<li><a href='".$data['weblink_url']."' target='_blank'>".$itemsubjectlink."</a><span class='sep'></span></li>\n";
		}
	} else {
